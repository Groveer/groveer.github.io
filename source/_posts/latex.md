...
swiperImg: 'https://pic.3gbizhi.com/2020/1111/20201111023253951.jpg' # 该文章在轮播图中的图片，可以是本地目录下图片也可以是http://xxx图片
img: 'https://pic.3gbizhi.com/2020/1111/20201111023253951.jpg' # 该文章图片，可以是本地目录下图片也可以是http://xxx图片
categories: Tool
tags: [Tool]
top: true
---
...
* [plantuml 包](/resources/plantuml-1.2022.6.jar)
